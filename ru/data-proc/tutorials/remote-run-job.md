...
1. [Создайте виртуальную машину](../../compute/operations/vm-create/create-linux-vm.md) с операционной системой, совпадающей с системой, используемой в кластере {{ dataproc-name }}, например, Ubuntu 20.04 LTS.
